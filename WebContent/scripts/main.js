(function() {
	...
	function register() {
		...
		if ( username == "" ) {
			showBlankUserNameError();
		} else if ( password == "" ) {
			showBlankPasswordError();
		} else {
	...
	function showRegisterSuccess() {
		$('hint').innerHTML = 'Successfully registered';
	}

	function showRegisterError() {
		$('hint').innerHTML = 'User name exists!';
	}
	function showBlankUserNameError() {
		$('hint').innerHTML = 'Enter username to register!';
	}
	function showBlankPasswordError() {
		$('hint').innerHTML = 'Password can not be left blank!';
	}
	...
	function showLoginError() {
		$('hint').innerHTML = 'Invalid username or password';
	}
